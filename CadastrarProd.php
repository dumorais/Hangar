    ...
    <body>
        ...
        <form class="form py-3 mb-3 mt-3 row borda" name="formulario_prod" action="Insert.php" method="post">
            ...
            <div class="col-md-6 form-group">
                <label class="font-weight-bold"> Nome do produto: </label> <br> <input class="form-control" type="text" name="NomeProd" value="" autofocus>
            </div>
            <div class="col-md-6 form-group">
                <label class="font-weight-bold"> Categoria: </label> <br> <input class="form-control" type="text" name="Categoria" value="" >
            </div>
            <div class="col-md-6 form-group">
                <label class="font-weight-bold"> Preço: </label> <br> <input class="form-control" type="text" name="Preco" value="" >
            </div>
            <div class="col-md-6 form-group">
                <label class="font-weight-bold"> Imagem: </label> <br> <input class="form-control" type="text" name="Imagem" value="img/" >
            </div>
